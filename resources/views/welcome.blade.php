...
<title>fluidbN | A creative, interesting and impactful media for the youth</title>
...
<header class="bgimg-1 w3-display-container w3-hide-small w3-hide-medium" id="home">
  ...
  <div class=" w3-text-white w3-display-left" style="padding:28px;">
    ...
    <span class="w3-xlarge coolhead" style="color:black;">A creative, interesting and impactful media for the youth <i class="fa fa-heart" style="color:red;font-size:30px;"></i></span>
...
<header class="bgimg-2 w3-display-container w3-hide-large" id="home">
    ...
    <div class=" w3-text-white w3-display-left" style="padding:15px;">
     ...
     <div style="margin-top:1%;">
      ...
      <span class="w3-large coolhead" style="color:black;"> A creative, interesting and impactful media for the youth <i class="fa fa-heart" style="color:red;font-size:30px;"></i></span>
...
<footer class="w3-center w3-white w3-padding-64 ">
  ...
  <p style="" class="">&copy; @php echo date('Y');@endphp fluidbN Media Technologies &middot; All rights reserved &middot; <a href="{{route('privacy')}}">Privacy</a> &middot; <a href="{{route('terms')}}">Terms</a></p>
   <p>Made with <i class="fa fa-heart" style="font-size:20px;color:red;"> </i> in India for the youth</p>        
